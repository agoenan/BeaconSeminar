...
```
cordova plugin add https://github.com/evothings/cordova-plugin-ibeacon.git
```
...
See the [LocationManager](https://github.com/evothings/cordova-plugin-ibeacon/blob/master/www/LocationManager.js)'s
...
### How to execute the tests - with Evothings Studio

* Launch Evothings Workbench on your computer (download from https://evothings.com/download)
* Build Evothings Viewer with the plugin you wish to test (instructions available at: https://github.com/evothings/evothings-viewer)
* Install and run the build of Evothings Viewer on an iOS phone and/or Android phone
* Connect to Evothings Workbench (get a connect code in the Workbench and enter it in the Viewer)
* Open the Tools window in the Workbench
* Paste the code from the examples into the JavaScript code pane, select the code you wish to run and click "Eval Selection", it should run without any errors.
